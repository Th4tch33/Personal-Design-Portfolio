...
• The page should include at least one “absolute” URL linking to an external website.

• ||DONE|| The page should include an email link to your uWaterloo email using the mailto: element (although we would never use mailto in a
...
• The page should include a small table describing some types of information using HTML.
...
• Use the float property for positioning and layout on your webpage.
...
• Style your HTML table using CSS to make it visually appealing.